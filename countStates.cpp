...
// This program is to count the number of states in Supervisory Control Report generated by the software STSLib.
    ...
    { 
        ...
        if (temp == "Applying the control patterns above, the system under control can reach the supremal state sets:")
		{
			...
			{ 
				...
				vector<string> v;
				SplitString(temp, v, ",");             // Three inputs: original string, resulting string, seperator.
				...
				for(vector<string>::size_type i = 0; i != v.size(); ++i)
				{
					...
					while (position != v[i].npos)      // Operate on each clause.
					{
						...
						{
							statesTemp += 1;           // Update the number of "/" in each clause.
